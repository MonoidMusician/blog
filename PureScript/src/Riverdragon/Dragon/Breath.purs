...
import Effect.Uncurried (EffectFn1, EffectFn3, EffectFn4, runEffectFn1, runEffectFn4)
...
foreign import unsafeSetProperty :: forall v. EffectFn3 Element (PropName v) v Unit
...
microtask :: Effect Unit -> Effect Unit
microtask = runEffectFn1 _microtask
foreign import _microtask :: EffectFn1 (Effect Unit) Unit
