...
You can paste that expression at [Live FRP DOM Coding](live-frp.html).^[Yeah, thatʼs all the code you need to try it out! it gets templated into a full module with a header, imports, declarations, and so on]
