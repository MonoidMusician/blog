---
title: HatStack
subtitle: "A stack based, concatenative language for [Hereditarily Finite Sets](hereditarily-finite-sets.html)"
author:
...
There is only one type: [Hereditarily Finite Sets](hereditarily-finite-sets.html), represented as arbitrary-precision natural numbers using the [Ackermann coding](https://en.wikipedia.org/wiki/Hereditarily_finite_set#Ackermann_coding).
